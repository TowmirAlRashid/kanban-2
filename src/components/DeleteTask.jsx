...
export default function AlertDialogSlide({
  ...
  const handleTaskDeleteClick = async () => {
    ...
    await handleTaskDelete({ Name, projectId, taskId, id });
  ...
  return (
    <div>
      ...
      >
        ...
        <Typography ml={3} mb={2} fontWeight="bold">
          Are you sure you want to delete this Task?
        </Typography>
        <Typography fontSize={20} ml={3} mb={1}>
          Task Name: <span style={{ fontWeight: "bold" }}>{Name}</span>
        </Typography>
